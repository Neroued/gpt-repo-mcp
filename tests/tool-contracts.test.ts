    ...
    expect(toolCatalog.map((tool) => ({
      ...
      [
        ...
        },
        {
          ...
          "description": "Use this when the user asks to inspect repository structure or locate likely files by directory. Supports tree_mode source_only/docs_only/tests_only/all plus include_globs and exclude_globs. Do not use this when the user asks to read file contents.",
          "inputKeys": [
            "cursor",
            "exclude_globs",
        ...
        },
        {
          ...
          "description": "Use this when the user needs a compact repository index with language stats, source/test/doc counts, largest files, CMake targets, and cache/index metadata before drilling into code.",
          "inputKeys": [
            "force_refresh",
            "repo_id",
          ],
        ...
        },
        {
          ...
          "description": "Use this when the user asks to list known repository symbols from the process-local index, optionally filtered by name, kind, include_globs, or exclude_globs.",
          "inputKeys": [
            "cursor",
            "exclude_globs",
            "force_refresh",
        ...
        },
        {
          ...
          "description": "Use this when the user asks to find code, inspect usages, perform a bughunt, or locate relevant files before reading them. Supports literal or regex query, multi-query OR/AND, include_globs, and exclude_globs. Prefer this before repo_read_many.",
          "inputKeys": [
            "combine",
            "context_lines",
            "cursor",
        ...
        },
        {
          ...
          "description": "Use this when the user asks to find a function, class, method, CUDA kernel, or other code symbol before reading the containing region.",
          "inputKeys": [
            "cursor",
            "exclude_globs",
            "force_refresh",
        ...
        },
        {
          ...
          "description": "Use this when the user needs a structural outline of one source file before reading it. Returns includes, classes, functions, methods, CUDA kernels, templates, TODO/FIXME items, and line ranges.",
          "inputKeys": [
            "max_symbols",
            "path",
            "repo_id",
        ...
        },
        {
          ...
          "description": "Use this when the user names a specific file or after repo_tree/repo_search identifies a relevant file. Supports start_line, end_line, max_lines pagination, has_more, and next_start_line. Do not use for broad repository review or large files when repo_outline_file/repo_fetch_region can be used.",
          "inputKeys": [
            "end_line",
            "max_bytes",
            "max_lines",
        ...
        },
        {
          ...
          "description": "Use this when the user needs one function, class, symbol, or around-line slice from a source file instead of fetching the whole file.",
          "inputKeys": [
            "context_lines",
            "line",
            "max_lines",
        ...
        },
        {
          ...
          "description": "Use this when the user has a previous repo_index_summary index_id and asks what changed since that repository index snapshot.",
          "inputKeys": [
            "force_refresh",
            "index_id",
            "repo_id",
